  ...
  return (
    <>
      <button
        ...
        className={
          "bg-indigo-700 z-20 px-5 py-2 rounded-md absolute top-3 right-0"
        }
      >
      ...
      <div
        className={clsx(
          "rounded-md absolute p-5 z-10 mb-8 transition-all ease-in-out duration-300 top-12 right-1 flex flex-col items-center justify-center group bg-indigo-700  w-auto",
